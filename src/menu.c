...
/*   Updated: 2022/01/06 14:20:40 by eassofi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	menu(t_fdf data)
{
	...
	mlx_string_put(data.mlx_ptr, data.win_ptr, 0, 250, 0xeb102f, menu);
	menu = "Press [F] : full screen";
	mlx_string_put(data.mlx_ptr, data.win_ptr, 0, 290, 0xeb102f, menu);
}
